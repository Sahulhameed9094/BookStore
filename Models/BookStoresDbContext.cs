...
public partial class BookStoresDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-PUBMPIF;Initial Catalog=BookStoresDB;Integrated Security=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Author>(entity =>
        {
            entity.HasKey(e => e.AuthorId).HasName("PK__Author__86516BCFD80167E1");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__490D1AE18C005EBA");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__Job__6E32B6A53DF578C0");
        ...
        {
            entity.HasKey(e => e.PubId).HasName("PK__Publishe__2515F222AD7D93F4");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__760965CCAA9679C8");
